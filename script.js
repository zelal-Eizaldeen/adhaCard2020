...
// VoiceRss api 
function  getEidMobarak() {
   audioElement.play();
    // VoiceRSS.speech({
    //     key: '5bae86c7dd6a40f8a885279be87a3b88',
    //     src: 'كل عام وأنتم بخير - عيدكم مبارك',
    //     v: 'Oda',
    //     hl: 'ar-eg',
    //     r: 0, 
    //     c: 'mp3',
...
// Event Listeners
//  button.addEventListener('click', getEidMobarak);
//  audioElement.addEventListener('ended', toggleButton);
button.addEventListener('click', ()=> (isPlaying ? pauseSong() : playSong()));
